...
import { User, Mail, Lock, LogOut, Shield, Clock, Eye, EyeOff, Crown, Settings2 } from "lucide-react";
import { useAuth } from "@/components/useAuth";

export default function AccountPage() {
  const router = useRouter();
  const { user: authUser } = useAuth(); // Get user with role info
  ...
  const getRoleInfo = () => {
    if (!authUser) return { title: "User", variant: "secondary" as const, icon: User };
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to sign out? You'll need to sign in again to access the management panel.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
