            ...
            <div className="col-span-full">
              <Card className="p-12 text-center border-dashed border-2">
                ...
                <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                  {search ? "Try adjusting your search terms to find what you're looking for" : "Create your first event to get started with managing your events"}
                </p>
                {!search && (
...
// Event Form component remains the same as in original code
function EventForm({
  existing,
  onSaved,
  onClose,
  ...
  const [form, setForm] = useState({
    ...
    maxTickets: existing?.maxTickets ?? 1,
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      setSaving(true);
      if (!form.name || !form.venue || !form.datetime) throw new Error("Please fill all required fields");
